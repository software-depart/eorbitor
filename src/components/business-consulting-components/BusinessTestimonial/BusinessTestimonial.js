...
const testimonial = [
    {
        id: '01',
        Des: "Working with eorbitor was a game-changer for our business. Their  tailored solutions and dedicated support propelled us to new heights",
        Title: 'Sarah Johnson',
                                ...
                                <div className="review_block_3" key={tsm}>
                                    ...
                                    <div className="review_admin">
                                        <div className="review_admin_image">
                                            <img src={testimonial.avatar} alt="Lokeswaran Kannan" />
                                        </div>
                            ...
                            <div className="about_image_3">
                                ...
                                <div className="funfact_block capsule_layout">
                                    <div className="funfact_icon">
                                        <img src={abImg2} alt="eorbitor - SVG Icon Wallet" />
                                    </div>
